...
pub enum ClientRequest {
    ...
    SetAuthCallback(SetAuthCallbackRequest),
}
...
pub struct SetAuthCallbackRequest {
    pub fetcher: Option<AuthTokenFetcher>,
}
    ...
    tokio::select! {
        ...
        Some(client_request) = client_request_receiver.recv() => {
            match client_request {
                ...
                ClientRequest::SetAuthCallback(req) => {
                    base_client.set_auth_fetcher(req.fetcher).await;
                    communicate(
                        base_client,
                        protocol_response_receiver,
                        watch_sender,
