...
BTreeMapStringValue serialize(Query101Args args) {
  return hashmapToBtreemap(
    hashmap: {
      'i': encodeValue(
        args.i.split(
          (on820824) => encodeValue(on820824),
          (on926503) => encodeValue(on926503),
          (on119738) => encodeValue(on119738),
        ),
      ),
    },
  );
  ...
  return (decodeValue(map) as IMap<String, dynamic>).then(
    (on508894) => (
      i: Union3<$1_0, $2_0, $3_0>(() {
        ...
        if (map.containsKey(on508894['i'])) {
          return map[on508894['i']];
        }
        throw Exception(
          (on508894['i'].toString() ?? "null") +
