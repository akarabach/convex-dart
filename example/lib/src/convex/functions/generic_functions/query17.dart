...
final query17 = createQueryOperation<Query17Args, Query17Response>(
  'generic_functions:query17',
  serialize,
  deserialize,
);
...
Query17Response deserialize(DartValue map) {
  return (decodeValue(map) as IMap<String, dynamic>).then(
    (on901247) => (
      i: on901247.containsKey('i')
          ? Defined((on901247['i'] as Uint8ListWithEquality))
