...
part 'unionReturn.freezed.dart';

@freezed
sealed class UnionReturnResponse with _$UnionReturnResponse {
  const factory UnionReturnResponse({required Union2<String, double> body}) =
      _UnionReturnResponse;
}
